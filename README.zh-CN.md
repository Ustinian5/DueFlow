...
<p align="center">
  ...
  <a href="https://github.com/Ustinian5/DueFlow/releases/tag/v0.1.2"><img alt="Apple Silicon 与 Intel 开发者预览版" src="https://img.shields.io/badge/macOS-Apple%20Silicon%20%2B%20Intel-111111?logo=apple"></a>
...
<p align="center">
  ...
  <a href="https://github.com/Ustinian5/DueFlow/releases/tag/v0.1.2">下载预览版</a> ·
...
<p align="center">
  ...
  <a href="https://github.com/Ustinian5/DueFlow/releases/download/v0.1.2/DueFlow-Desktop_0.1.2_arm64.app.zip"><strong>下载 Apple Silicon 版</strong></a> ·
  <a href="https://github.com/Ustinian5/DueFlow/releases/download/v0.1.2/DueFlow-Desktop_0.1.2_x86_64.app.zip"><strong>下载 Intel 版</strong></a>
</p>
...
DueFlow `0.1.2` 已可用于本地开发和开源审查。原生 Apple Silicon 与 Intel 开发者预览版均为自包含 `.app.zip`：仅绑定回环地址的本地 API 已作为 sidecar 打包，测试者运行时不需要 Python 或 Conda。预览版未签名、未公证，分发边界记录在发布指南中。
...
请从 [DueFlow v0.1.2](https://github.com/Ustinian5/DueFlow/releases/tag/v0.1.2) 下载原生 [Apple Silicon](https://github.com/Ustinian5/DueFlow/releases/download/v0.1.2/DueFlow-Desktop_0.1.2_arm64.app.zip) 或 [Intel](https://github.com/Ustinian5/DueFlow/releases/download/v0.1.2/DueFlow-Desktop_0.1.2_x86_64.app.zip) `.app.zip`。每种架构均提供独立校验和与发布清单；清单记录内置后端哈希值和打包时自检结果。开发者预览版未签名、未公证，仅适合接受开源开发构建边界的测试者。
